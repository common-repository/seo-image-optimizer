...
if (isset($_POST['weblizar_wsio_settings_save_section_general'])) {
    ...
    if ($_POST['weblizar_wsio_settings_save_section_general'] == 1) {
        ...
        $i = 0;
        if( isset( $_POST['wsio_alt_attribute_value'] ) ){
            ...
            $_POST['wsio_alt_attribute_value'] = null;
        }

        $j = 0;
        if( isset( $_POST['wsio_title_tag_value'] ) ){
            ...
            $_POST['wsio_title_tag_value'] = null;
        }    

        if( isset( $user_get_id ) ){
...
if (isset($_POST['weblizar_wsio_settings_save_image_size_option'])) {
    ...
    if ($_POST['weblizar_wsio_settings_save_image_size_option'] == 1) {
        ...
        if ( isset( $_POST['wsio_image_resize_yesno'] ) ) {
        ...
        if ( isset( $_POST['wsio_image_recompress_yesno'] ) ) {
